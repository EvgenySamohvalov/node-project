...
* Команда в терминале `docker run -e NAME=Evgene -e SURNAME=Samokhvalov --name mynode -i -t node:15.14`
...
* Команда в терминале `console.log(`Привет, ${process.env.NAME} ${process.env.SURNAME}!!!`)`

* Результат

```
Привет, Evgene Samokhvalov!!!
```


4. Остановите контейнер
* Команда в терминале `docker stop mynode & docker rm mynode`
